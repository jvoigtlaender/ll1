...
Elm.LL = Elm.LL || {};
Elm.LL.make = function (_elm) {
   "use strict";
   _elm.LL = _elm.LL || {};
   if (_elm.LL.values) return _elm.LL.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $List = Elm.List.make(_elm),
   ...
   var dropDuplicates = function (list) {
      ...
      if (_p0.ctor === "::" && _p0._1.ctor === "::") {
            var _p1 = _p0._0;
            return A2($List._op["::"],_p1,dropDuplicates(A2($List.filter,F2(function (x,y) {    return !_U.eq(x,y);})(_p1),_p0._1)));
         } else {
            return list;
         }
   };
   var add = F3(function (a,bs,list) {
      var _p2 = {ctor: "_Tuple2",_0: bs,_1: list};
      _v1_0: do {
         if (_p2._1.ctor === "[]") {
               if (_p2._0.ctor === "[]") {
                     break _v1_0;
                  } else {
                     return _U.list([{ctor: "_Tuple2",_0: a,_1: bs}]);
                  }
            } else {
               if (_p2._0.ctor === "[]") {
                     break _v1_0;
                     ...
                     var _p5 = _p2._1._1;
                     var _p4 = _p2._1._0._1;
                     var _p3 = _p2._1._0._0;
                     return _U.eq(a,_p3) ? A2($List._op["::"],
                     {ctor: "_Tuple2",_0: _p3,_1: dropDuplicates(A2($Basics._op["++"],_p4,bs))},
                     _p5) : A2($List._op["::"],{ctor: "_Tuple2",_0: _p3,_1: _p4},A3(add,a,bs,_p5));
                  }
            }
      } while (false);
      return list;
   });
   var add$ = F4(function (a,bs,c,list) {
      var _p6 = list;
      if (_p6.ctor === "[]") {
            return _U.list([{ctor: "_Tuple2",_0: a,_1: A2($List.map,function (b) {    return {ctor: "_Tuple2",_0: b,_1: _U.list([c])};},bs)}]);
         } else {
            var _p9 = _p6._1;
            var _p8 = _p6._0._1;
            var _p7 = _p6._0._0;
            return _U.eq(a,_p7) ? A2($List._op["::"],
            {ctor: "_Tuple2",_0: _p7,_1: A3($List.foldl,function (b) {    return A2(add,b,_U.list([c]));},_p8,bs)},
            _p9) : A2($List._op["::"],{ctor: "_Tuple2",_0: _p7,_1: _p8},A4(add$,a,bs,c,_p9));
         }
   });
   var get = F2(function (nt,list) {
      get: while (true) {
         var _p10 = list;
         if (_p10.ctor === "[]") {
               return _U.list([]);
            } else {
               if (_U.eq(_p10._0._0,nt)) return _p10._0._1; else {
                     var _v4 = nt,_v5 = _p10._1;
                     nt = _v4;
                     list = _v5;
                     continue get;
                  }
   ...
   var firstExtended = F2(function (rhs,firsts) {
      var _p11 = rhs;
      if (_p11.ctor === "[]") {
            return _U.list([$Maybe.Nothing]);
         } else {
            if (_p11._0.ctor === "T") {
                  return _U.list([$Maybe.Just(_p11._0._0)]);
               } else {
                  var bs = A2(get,_p11._0._0,firsts);
                  return A2($List.member,$Maybe.Nothing,bs) ? A2($Basics._op["++"],
                  A2($List.filter,F2(function (x,y) {    return !_U.eq(x,y);})($Maybe.Nothing),bs),
                  A2(firstExtended,_p11._1,firsts)) : bs;
               }
         }
   });
   var followStep = F4(function (firsts,nt,rhs,follows) {
      var ntFollows = A2($Maybe.withDefault,_U.list([]),A2($Maybe.map,function (a) {    return A2(get,a,follows);},nt));
      var toAdd = function (rhs) {
         toAdd: while (true) {
            var _p12 = rhs;
            if (_p12.ctor === "[]") {
                  return _U.list([]);
                  ...
                  if (_p12._0.ctor === "T") {
                        ...
                        var _p13 = _p12._1;
                        var bs = A2(firstExtended,_p13,firsts);
                        return A2($List._op["::"],
                        {ctor: "_Tuple2"
                        ,_0: _p12._0._0
                        ,_1: A2($Basics._op["++"],A2($List.filterMap,$Basics.identity,bs),A2($List.member,$Maybe.Nothing,bs) ? ntFollows : _U.list([]))},
                        toAdd(_p13));
                     }
               }
         }
      };
      return A3($List.foldl,$Basics.uncurry(add),follows,toAdd(rhs));
   });
   var firstStep = F3(function (nt,rhs,firsts) {    return A3(add,nt,A2(firstExtended,rhs,firsts),firsts);});
   var CFG = F4(function (a,b,c,d) {    return {ctor: "CFG",_0: a,_1: b,_2: c,_3: d};});
   var T = function (a) {    return {ctor: "T",_0: a};};
   var predictionStep = F4(function (firsts,follows,nt,rhs) {
      var fromJust = function (m) {
         var _p14 = m;
         if (_p14.ctor === "Nothing") {
               return _U.crashCase("LL",{start: {line: 102,column: 13},end: {line: 107,column: 22}},_p14)("IMPOSSIBLE!");
            } else {
               return _p14._0;
            }
      };
      return A3(add$,
      nt,
      dropDuplicates(A2($List.concatMap,
      function (b) {
         return A2($List.map,fromJust,A2(firstExtended,A2($Basics._op["++"],rhs,_U.list([T(b)])),firsts));
      },
      A2(get,nt,follows))),
      rhs);
   });
   var NT = function (a) {    return {ctor: "NT",_0: a};};
   return _elm.LL.values = {_op: _op,firstStep: firstStep,followStep: followStep,predictionStep: predictionStep,get: get,NT: NT,T: T,CFG: CFG};
};
Elm.Component = Elm.Component || {};
Elm.Component.make = function (_elm) {
   "use strict";
   _elm.Component = _elm.Component || {};
   if (_elm.Component.values) return _elm.Component.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Html = Elm.Html.make(_elm),
   ...
   $String = Elm.String.make(_elm);
   var _op = {};
   var tryAnyStep = F2(function (step,table) {
      return A2($List.foldl,
      F2(function (_p0,m) {
         var _p1 = _p0;
         var _p2 = m;
         if (_p2.ctor === "Nothing") {
               var table$ = A3(step,_p1._0,_p1._1,table);
               return _U.eq(table,table$) ? $Maybe.Nothing : $Maybe.Just(table$);
            } else {
               return m;
            }
      }),
   ...
   var Predictions = {ctor: "Predictions"};
   var Follow = {ctor: "Follow"};
   var Step = {ctor: "Step"};
   var Escape = {ctor: "Escape"};
   var Down = {ctor: "Down"};
   var Up = {ctor: "Up"};
   var Select = function (a) {    return {ctor: "Select",_0: a};};
   var ComputingPredictions = {ctor: "ComputingPredictions"};
   var FollowFinished = {ctor: "FollowFinished"};
   var ComputingFollow = {ctor: "ComputingFollow"};
   var FirstFinished = {ctor: "FirstFinished"};
   var update = F2(function (action,_p3) {
      var _p4 = _p3;
      var _p41 = _p4.stage;
      var _p40 = _p4.selected;
      var _p39 = _p4.predictions;
      var _p38 = _p4;
      var _p37 = _p4.followTable;
      var _p36 = _p4.firstTable;
      var head$ = function (xs) {
         var _p5 = xs;
         if (_p5.ctor === "::") {
               return _p5._0;
            } else {
               return _U.crashCase("Component",{start: {line: 242,column: 13},end: {line: 247,column: 46}},_p5)("IMPOSSIBLE!");
            }
      };
      var _p7 = _p4.cfg;
      var s = _p7._0;
      var rules = _p7._3;
      var pseudoRule = {ctor: "_Tuple2",_0: $Maybe.Nothing,_1: _U.list([$LL.NT(s),$LL.T("#")])};
      var rules$ = A2($Basics._op["++"],
      A2($List.map,function (_p8) {    var _p9 = _p8;return {ctor: "_Tuple2",_0: $Maybe.Just(_p9._0),_1: _p9._1};},rules),
      A2($List.member,_p41,_U.list([ComputingFollow,FollowFinished])) ? _U.list([pseudoRule]) : _U.list([]));
      var _p10 = {ctor: "_Tuple2",_0: _p41,_1: action};
      switch (_p10._1.ctor)
      {case "Select": return _U.update(_p38,
           {selected: _U.eq(A2($Maybe.map,$Basics.fst,_p40),$Maybe.Just(_p10._1._0._0)) ? $Maybe.Nothing : $Maybe.Just(_p10._1._0)});
         case "Up": return _U.update(_p38,
           {selected: A2($Maybe.map,
           function (_p11) {
              var _p12 = _p11;
              var _p13 = _p12._0;
              var i$ = _p13 - 1;
              return _U.cmp(i$,0) < 0 ? {ctor: "_Tuple2",_0: _p13,_1: _p12._1} : {ctor: "_Tuple2",_0: i$,_1: head$(A2($List.drop,i$,rules$))};
           },
           _p40)});
         case "Down": return _U.update(_p38,
           {selected: A2($Maybe.map,
           function (_p14) {
              var _p15 = _p14;
              var _p16 = _p15._0;
              var i$ = _p16 + 1;
              return _U.cmp(i$,$List.length(rules$)) > -1 ? {ctor: "_Tuple2",_0: _p16,_1: _p15._1} : {ctor: "_Tuple2"
                                                                                                     ,_0: i$
                                                                                                     ,_1: head$(A2($List.drop,i$,rules$))};
           },
           _p40)});
         case "Escape": return _U.update(_p38,{selected: $Maybe.Nothing});
         case "Follow": return _U.update(_p38,{stage: ComputingFollow,selected: $Maybe.Just({ctor: "_Tuple2",_0: $List.length(rules),_1: pseudoRule})});
         case "Predictions": return _U.update(_p38,
           {stage: ComputingPredictions
           ,selected: A2($Maybe.map,
           function (_p29) {
              var _p30 = _p29;
              return {ctor: "_Tuple2",_0: 0,_1: {ctor: "_Tuple2",_0: $Maybe.Just(_p30._0),_1: _p30._1}};
           },
           $List.head(rules))});
         default: switch (_p10._0.ctor)
           {case "ComputingFirst": var process = function (_p17) {
                   var _p18 = _p17;
                   var _p19 = _p18._0;
                   if (_p19.ctor === "Nothing") {
                         return _U.crashCase("Component",{start: {line: 299,column: 25},end: {line: 304,column: 85}},_p19)("IMPOSSIBLE!");
                      } else {
                         return _U.update(_p38,{firstTable: A3($LL.firstStep,_p19._0,_p18._1,_p36)});
                      }
                };
                return function (_p21) {
                   var _p22 = _p21;
                   return _U.update(_p22,{stage: _U.eq(A3(tryAnyStep,$LL.firstStep,_p22.firstTable,rules),$Maybe.Nothing) ? FirstFinished : _p41});
                }(A2($Maybe.withDefault,
                _U.update(_p38,{firstTable: A2($Maybe.withDefault,_p36,A3(tryAnyStep,$LL.firstStep,_p36,rules))}),
                A2($Maybe.map,function (_p23) {    return process($Basics.snd(_p23));},_p40)));
              case "FirstFinished": return _p38;
              case "ComputingFollow": var process = function (_p24) {
                   var _p25 = _p24;
                   return _U.update(_p38,{followTable: A4($LL.followStep,_p36,_p25._0,_p25._1,_p37)});
                };
                return function (_p26) {
                   var _p27 = _p26;
                   return _U.update(_p27,{stage: _U.eq(A3(tryAnyStep,$LL.followStep(_p36),_p27.followTable,rules$),$Maybe.Nothing) ? FollowFinished : _p41});
                }(A2($Maybe.withDefault,
                _U.update(_p38,{followTable: A2($Maybe.withDefault,_p37,A3(tryAnyStep,$LL.followStep(_p36),_p37,$List.reverse(rules$)))}),
                A2($Maybe.map,function (_p28) {    return process($Basics.snd(_p28));},_p40)));
              case "FollowFinished": return _p38;
              default: var process = function (_p31) {
                   var _p32 = _p31;
                   var _p33 = _p32._0;
                   if (_p33.ctor === "Nothing") {
                         return _U.crashCase("Component",{start: {line: 348,column: 25},end: {line: 353,column: 115}},_p33)("IMPOSSIBLE!");
                      } else {
                         return _U.update(_p38,{predictions: A5($LL.predictionStep,_p36,_p37,_p33._0,_p32._1,_p39)});
                      }
                };
                return A2($Maybe.withDefault,
                _U.update(_p38,{predictions: A2($Maybe.withDefault,_p39,A3(tryAnyStep,A2($LL.predictionStep,_p36,_p37),_p39,rules))}),
                A2($Maybe.map,function (_p35) {    return process($Basics.snd(_p35));},_p40));}}
   });
   var ComputingFirst = {ctor: "ComputingFirst"};
   var view = F2(function (address,_p42) {
      var _p43 = _p42;
      var _p51 = _p43.stage;
      var cellStyle = _U.list([{ctor: "_Tuple2",_0: "border",_1: "1px solid black"},{ctor: "_Tuple2",_0: "padding",_1: "5px"}]);
      var inFollow = A2($List.member,_p51,_U.list([ComputingFollow,FollowFinished]));
      var inFirst = A2($List.member,_p51,_U.list([ComputingFirst,FirstFinished]));
      var toStr = function (x) {    var _p44 = x;if (_p44.ctor === "NT") {    return _p44._0;} else {    return _p44._0;}};
      var renderRHS = function (rhs) {
         var _p45 = rhs;
         if (_p45.ctor === "[]") {
               return "ε";
            } else {
               return $String.concat(A2($List.intersperse," ",A2($List.map,toStr,rhs)));
            }
      };
      var _p46 = _p43.cfg;
      var s = _p46._0;
      ...
      var rules = _p46._3;
      var pseudoRule = {ctor: "_Tuple2",_0: $Maybe.Nothing,_1: _U.list([$LL.NT(s),$LL.T("#")])};
      var ts$ = A2($Basics._op["++"],ts,_U.list(["#"]));
      return A2($Html.div,
      _U.list([]),
      A2($Basics._op["++"],
      ...
      _U.list([A2($Html.tr,
              _U.list([]),
              _U.list([A2($Html.th,
                      _U.list([$Html$Attributes.style(_U.list([{ctor: "_Tuple2",_0: "width",_1: "33%"}])),$Html$Attributes.align("left")]),
                      _U.list([$Html.text("Grammatik")]))
                      ,A2($Html.th,
                      _U.list([$Html$Attributes.style(_U.list([{ctor: "_Tuple2",_0: "width",_1: "22%"}])),$Html$Attributes.align("left")]),
                      _U.list([$Html.text("FIRST-Mengen")]))
                      ,A2($Html.th,_U.list([$Html$Attributes.align("left")]),inFirst ? _U.list([]) : _U.list([$Html.text("FOLLOW-Mengen")]))]))
              ,A2($Html.tr,
              _U.list([]),
              A2($Basics._op["++"],
              _U.list([A2($Html.td,
                      _U.list([A2($Html$Attributes.attribute,"valign","top")]),
                      _U.list([A2($Html.ol,
                      _U.list([]),
                      A2($List.indexedMap,
                      F2(function (i,_p47) {
                         ...
                         return A2($Html.li,
                         A2($Basics._op["++"],
                         _U.list([A2($Html$Events.onClick,address,Select({ctor: "_Tuple2",_0: i,_1: _p48}))]),
                         _U.eq(A2($Maybe.map,$Basics.fst,_p43.selected),$Maybe.Just(i)) ? _U.list([$Html$Attributes.style(_U.list([{ctor: "_Tuple2"
                                                                                                                                   ,_0: "backgroundColor"
                                                                                                                                   ,_1: "yellow"}
                                                                                                                                  ,{ctor: "_Tuple2"
                                                                                                                                   ,_0: "width"
                                                                                                                                   ,_1: "90%"}]))]) : _U.list([])),
                         _U.list([$Html.text(A2($Basics._op["++"],A2($Maybe.withDefault,"",_p48._0),A2($Basics._op["++"]," ⇾ ",renderRHS(_p48._1))))]));
                      }),
                      A2($Basics._op["++"],
                      A2($List.map,function (_p49) {    var _p50 = _p49;return {ctor: "_Tuple2",_0: $Maybe.Just(_p50._0),_1: _p50._1};},rules),
                      inFollow ? _U.list([pseudoRule]) : _U.list([]))))]))
                      ,A2($Html.td,
                      _U.list([A2($Html$Attributes.attribute,"valign","top")]),
                      A2($Basics._op["++"],
                      _U.list([A2($Html.dl,
                      ...
                      A2($List.concatMap,
                      function (nt) {
                         var entries = A2($LL.get,nt,_p43.firstTable);
                         return _U.list([A2($Html.dt,_U.list([]),_U.list([$Html.text(A2($Basics._op["++"],nt,":"))]))
                                        ,A2($Html.dd,
                                        _U.list([]),
                                        _U.list([$Html.text($List.isEmpty(entries) ? "Ø" : A2($Basics._op["++"],
                                        "{ ",
                                        A2($Basics._op["++"],
                                        $String.concat(A2($List.intersperse," , ",A2($List.map,$Maybe.withDefault("ε"),entries))),
                                        " }")))]))]);
                      },
                      A2($List._op["::"],s,os)))]),
                      A2($Basics._op["++"],
                      inFirst ? _U.list([A2($Html.button,
                      _U.list([$Html$Attributes.id("step"),A2($Html$Events.onClick,address,Step),$Html$Attributes.autofocus(true)]),
                      _U.list([$Html.text("Schritt")]))]) : _U.list([]),
                      _U.eq(_p51,FirstFinished) ? _U.list([A2($Html.button,
                      _U.list([A2($Html$Events.onClick,address,Follow)]),
                      _U.list([$Html.text("Follow")]))]) : _U.list([]))))]),
              inFirst ? _U.list([]) : _U.list([A2($Html.td,
              _U.list([A2($Html$Attributes.attribute,"valign","top")]),
              A2($Basics._op["++"],
              _U.list([A2($Html.dl,
              _U.list([]),
              A2($List.concatMap,
              function (nt) {
                 var entries = A2($LL.get,nt,_p43.followTable);
                 return _U.list([A2($Html.dt,_U.list([]),_U.list([$Html.text(A2($Basics._op["++"],nt,":"))]))
                                ,A2($Html.dd,
                                _U.list([]),
                                _U.list([$Html.text($List.isEmpty(entries) ? "Ø" : A2($Basics._op["++"],
                                "{ ",
                                A2($Basics._op["++"],$String.concat(A2($List.intersperse," , ",entries))," }")))]))]);
              },
              A2($List._op["::"],s,os)))]),
              A2($Basics._op["++"],
              inFollow ? _U.list([A2($Html.button,
              _U.list([$Html$Attributes.id("step"),A2($Html$Events.onClick,address,Step)]),
              _U.list([$Html.text("Schritt")]))]) : _U.list([]),
              _U.eq(_p51,FollowFinished) ? _U.list([A2($Html.button,
              _U.list([A2($Html$Events.onClick,address,Predictions)]),
              _U.list([$Html.text("Tabelle")]))]) : _U.list([]))))])))]))]),
      _U.eq(_p51,ComputingPredictions) ? _U.list([A2($Html.h4,_U.list([]),_U.list([$Html.text("Vorhersagetabelle")]))
                                                 ,A2($Html.table,
                                                 _U.list([$Html$Attributes.style(_U.list([{ctor: "_Tuple2",_0: "border-collapse",_1: "collapse"}]))]),
                                                 A2($List._op["::"],
                                                 A2($Html.tr,
                                                 ...
                                                 _U.list([$Html$Attributes.id("step"),A2($Html$Events.onClick,address,Step)]),
                                                 _U.list([$Html.text("Schritt")]))])),
                                                 A2($List.map,
                                                 function (t) {
                                                    return A2($Html.td,_U.list([$Html$Attributes.style(cellStyle)]),_U.list([$Html.text(t)]));
                                                 },
                                                 ts$))),
                                                 A2($List.map,
                                                 function (nt) {
                                                    ...
                                                    _U.list([$Html$Attributes.align("center")]),
                                                    A2($List._op["::"],
                                                    A2($Html.td,_U.list([$Html$Attributes.style(cellStyle)]),_U.list([$Html.text(nt)])),
                                                    A2($List.map,
                                                    function (t) {
                                                       var rhss = A2($LL.get,t,A2($LL.get,nt,_p43.predictions));
                                                       return A2($Html.td,
                                                       _U.list([$Html$Attributes.style(_U.cmp($List.length(rhss),2) < 0 ? cellStyle : A2($List._op["::"],
                                                       {ctor: "_Tuple2",_0: "color",_1: "red"},
                                                       cellStyle))]),
                                                       _U.list([$Html.text($String.concat(A2($List.intersperse," , ",A2($List.map,renderRHS,rhss))))]));
                                                    },
                                                    ts$)));
                                                 },
                                                 A2($List._op["::"],s,os))))
                                                 ,A2($Html.p,_U.list([]),_U.list([]))]) : _U.list([])));
   });
   var init = function (_p52) {
      var _p53 = _p52;
      return {cfg: _p53
             ,selected: A2($Maybe.map,
             function (_p54) {
                var _p55 = _p54;
                return {ctor: "_Tuple2",_0: 0,_1: {ctor: "_Tuple2",_0: $Maybe.Just(_p55._0),_1: _p55._1}};
             },
             $List.head(_p53._3))
   ...
   return _elm.Component.values = {_op: _op
                                  ,init: init
                                  ,view: view
                                  ,update: update
                                  ,Select: Select
...
Elm.Examples.make = function (_elm) {
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var cfg_lr_exercise = A4($LL.CFG,
   "Exp\'",
   _U.list(["Exp","Term"]),
   _U.list(["+","-","num","(",")"]),
   _U.list([{ctor: "_Tuple2",_0: "Exp\'",_1: _U.list([$LL.NT("Exp")])}
           ,{ctor: "_Tuple2",_0: "Exp",_1: _U.list([$LL.NT("Exp"),$LL.T("+"),$LL.NT("Term")])}
           ,{ctor: "_Tuple2",_0: "Exp",_1: _U.list([$LL.NT("Exp"),$LL.T("-"),$LL.NT("Term")])}
           ,{ctor: "_Tuple2",_0: "Exp",_1: _U.list([$LL.NT("Term")])}
           ,{ctor: "_Tuple2",_0: "Term",_1: _U.list([$LL.T("num")])}
           ,{ctor: "_Tuple2",_0: "Term",_1: _U.list([$LL.T("("),$LL.NT("Exp"),$LL.T(")")])}]));
   var cfg_lr_lecture = A4($LL.CFG,
   "S\'",
   _U.list(["S","R"]),
   _U.list(["a","b","c"]),
   _U.list([{ctor: "_Tuple2",_0: "S\'",_1: _U.list([$LL.NT("S")])}
           ,{ctor: "_Tuple2",_0: "S",_1: _U.list([$LL.NT("R")])}
           ,{ctor: "_Tuple2",_0: "S",_1: _U.list([$LL.T("a"),$LL.NT("S"),$LL.T("c")])}
           ,{ctor: "_Tuple2",_0: "R",_1: _U.list([])}
           ,{ctor: "_Tuple2",_0: "R",_1: _U.list([$LL.T("b"),$LL.NT("R")])}]));
   var cfg_arith_simpl_mod_norec = A4($LL.CFG,
   "E",
   _U.list(["E\'","E\'\'"]),
   _U.list(["+","*","(",")","int"]),
   _U.list([{ctor: "_Tuple2",_0: "E",_1: _U.list([$LL.T("int"),$LL.NT("E\'\'")])}
           ,{ctor: "_Tuple2",_0: "E",_1: _U.list([$LL.T("("),$LL.NT("E"),$LL.T(")"),$LL.NT("E\'\'")])}
           ,{ctor: "_Tuple2",_0: "E\'\'",_1: _U.list([$LL.NT("E\'"),$LL.NT("E\'\'")])}
           ,{ctor: "_Tuple2",_0: "E\'\'",_1: _U.list([])}
           ,{ctor: "_Tuple2",_0: "E\'",_1: _U.list([$LL.T("+"),$LL.NT("E")])}
           ,{ctor: "_Tuple2",_0: "E\'",_1: _U.list([$LL.T("*"),$LL.NT("E")])}]));
   var cfg_arith_simpl_mod = A4($LL.CFG,
   "E",
   _U.list(["E\'"]),
   _U.list(["+","*","(",")","int"]),
   _U.list([{ctor: "_Tuple2",_0: "E",_1: _U.list([$LL.NT("E"),$LL.NT("E\'")])}
           ,{ctor: "_Tuple2",_0: "E\'",_1: _U.list([$LL.T("+"),$LL.NT("E")])}
           ,{ctor: "_Tuple2",_0: "E\'",_1: _U.list([$LL.T("*"),$LL.NT("E")])}
           ,{ctor: "_Tuple2",_0: "E",_1: _U.list([$LL.T("int")])}
           ,{ctor: "_Tuple2",_0: "E",_1: _U.list([$LL.T("("),$LL.NT("E"),$LL.T(")")])}]));
   var cfg_arith_simpl = A4($LL.CFG,
   "E",
   _U.list([]),
   _U.list(["+","*","(",")","int"]),
   _U.list([{ctor: "_Tuple2",_0: "E",_1: _U.list([$LL.NT("E"),$LL.T("+"),$LL.NT("E")])}
           ,{ctor: "_Tuple2",_0: "E",_1: _U.list([$LL.NT("E"),$LL.T("*"),$LL.NT("E")])}
           ,{ctor: "_Tuple2",_0: "E",_1: _U.list([$LL.T("int")])}
           ,{ctor: "_Tuple2",_0: "E",_1: _U.list([$LL.T("("),$LL.NT("E"),$LL.T(")")])}]));
   var cfg_arith_mod = A4($LL.CFG,
   "E",
   _U.list(["E\'","T","T\'","F"]),
   _U.list(["+","*","(",")","int"]),
   _U.list([{ctor: "_Tuple2",_0: "E",_1: _U.list([$LL.NT("T"),$LL.NT("E\'")])}
           ,{ctor: "_Tuple2",_0: "E\'",_1: _U.list([$LL.T("+"),$LL.NT("E")])}
           ,{ctor: "_Tuple2",_0: "E\'",_1: _U.list([])}
           ,{ctor: "_Tuple2",_0: "T",_1: _U.list([$LL.NT("F"),$LL.NT("T\'")])}
           ,{ctor: "_Tuple2",_0: "T\'",_1: _U.list([$LL.T("*"),$LL.NT("T")])}
           ,{ctor: "_Tuple2",_0: "T\'",_1: _U.list([])}
           ,{ctor: "_Tuple2",_0: "F",_1: _U.list([$LL.T("int")])}
           ,{ctor: "_Tuple2",_0: "F",_1: _U.list([$LL.T("("),$LL.NT("E"),$LL.T(")")])}]));
   var cfg_arith = A4($LL.CFG,
   "E",
   _U.list(["T","F"]),
   _U.list(["+","*","(",")","int"]),
   _U.list([{ctor: "_Tuple2",_0: "E",_1: _U.list([$LL.NT("T"),$LL.T("+"),$LL.NT("E")])}
           ,{ctor: "_Tuple2",_0: "E",_1: _U.list([$LL.NT("T")])}
           ,{ctor: "_Tuple2",_0: "T",_1: _U.list([$LL.NT("F"),$LL.T("*"),$LL.NT("T")])}
           ,{ctor: "_Tuple2",_0: "T",_1: _U.list([$LL.NT("F")])}
           ,{ctor: "_Tuple2",_0: "F",_1: _U.list([$LL.T("int")])}
           ,{ctor: "_Tuple2",_0: "F",_1: _U.list([$LL.T("("),$LL.NT("E"),$LL.T(")")])}]));
   var cfg_left_associative_arith_norec = A4($LL.CFG,
   "Exp",
   _U.list(["Exp\'","Term","Term\'","Factor"]),
   _U.list(["-","*","(",")","int"]),
   _U.list([{ctor: "_Tuple2",_0: "Exp",_1: _U.list([$LL.NT("Term"),$LL.NT("Exp\'")])}
           ,{ctor: "_Tuple2",_0: "Exp\'",_1: _U.list([$LL.T("-"),$LL.NT("Term"),$LL.NT("Exp\'")])}
           ,{ctor: "_Tuple2",_0: "Exp\'",_1: _U.list([])}
           ,{ctor: "_Tuple2",_0: "Term",_1: _U.list([$LL.NT("Factor"),$LL.NT("Term\'")])}
           ,{ctor: "_Tuple2",_0: "Term\'",_1: _U.list([$LL.T("*"),$LL.NT("Factor"),$LL.NT("Term\'")])}
           ,{ctor: "_Tuple2",_0: "Term\'",_1: _U.list([])}
           ,{ctor: "_Tuple2",_0: "Factor",_1: _U.list([$LL.T("int")])}
           ,{ctor: "_Tuple2",_0: "Factor",_1: _U.list([$LL.T("("),$LL.NT("Exp"),$LL.T(")")])}]));
   var cfg_left_associative_arith = A4($LL.CFG,
   "Exp",
   _U.list(["Term","Factor"]),
   _U.list(["-","*","(",")","int"]),
   _U.list([{ctor: "_Tuple2",_0: "Exp",_1: _U.list([$LL.NT("Exp"),$LL.T("-"),$LL.NT("Term")])}
           ,{ctor: "_Tuple2",_0: "Exp",_1: _U.list([$LL.NT("Term")])}
           ,{ctor: "_Tuple2",_0: "Term",_1: _U.list([$LL.NT("Term"),$LL.T("*"),$LL.NT("Factor")])}
           ,{ctor: "_Tuple2",_0: "Term",_1: _U.list([$LL.NT("Factor")])}
           ,{ctor: "_Tuple2",_0: "Factor",_1: _U.list([$LL.T("int")])}
           ,{ctor: "_Tuple2",_0: "Factor",_1: _U.list([$LL.T("("),$LL.NT("Exp"),$LL.T(")")])}]));
   var cfg_exam = A4($LL.CFG,
   "S",
   _U.list(["A","B","B\'"]),
   _U.list(["a","b"]),
   _U.list([{ctor: "_Tuple2",_0: "S",_1: _U.list([$LL.NT("A"),$LL.NT("B")])}
           ,{ctor: "_Tuple2",_0: "A",_1: _U.list([$LL.T("a"),$LL.NT("A")])}
           ,{ctor: "_Tuple2",_0: "A",_1: _U.list([])}
           ,{ctor: "_Tuple2",_0: "B",_1: _U.list([$LL.T("b"),$LL.NT("B\'")])}
           ,{ctor: "_Tuple2",_0: "B\'",_1: _U.list([])}
           ,{ctor: "_Tuple2",_0: "B\'",_1: _U.list([$LL.T("b"),$LL.NT("B\'")])}]));
   var cfg_8_9_no_eps_mod = A4($LL.CFG,
   "Session",
   _U.list(["Facts","Facts\'","Fact","Question"]),
   _U.list(["(",")","!","?","STRING"]),
   _U.list([{ctor: "_Tuple2",_0: "Session",_1: _U.list([$LL.NT("Facts"),$LL.NT("Question")])}
           ,{ctor: "_Tuple2",_0: "Session",_1: _U.list([$LL.NT("Question")])}
           ,{ctor: "_Tuple2",_0: "Session",_1: _U.list([$LL.T("("),$LL.NT("Session"),$LL.T(")"),$LL.NT("Session")])}
           ,{ctor: "_Tuple2",_0: "Facts",_1: _U.list([$LL.NT("Fact"),$LL.NT("Facts\'")])}
           ,{ctor: "_Tuple2",_0: "Facts\'",_1: _U.list([$LL.NT("Facts")])}
           ,{ctor: "_Tuple2",_0: "Facts\'",_1: _U.list([])}
           ,{ctor: "_Tuple2",_0: "Fact",_1: _U.list([$LL.T("!"),$LL.T("STRING")])}
           ,{ctor: "_Tuple2",_0: "Question",_1: _U.list([$LL.T("?"),$LL.T("STRING")])}]));
   var cfg_8_9_no_eps = A4($LL.CFG,
   "Session",
   _U.list(["Facts","Fact","Question"]),
   _U.list(["(",")","!","?","STRING"]),
   _U.list([{ctor: "_Tuple2",_0: "Session",_1: _U.list([$LL.NT("Facts"),$LL.NT("Question")])}
           ,{ctor: "_Tuple2",_0: "Session",_1: _U.list([$LL.NT("Question")])}
           ,{ctor: "_Tuple2",_0: "Session",_1: _U.list([$LL.T("("),$LL.NT("Session"),$LL.T(")"),$LL.NT("Session")])}
           ,{ctor: "_Tuple2",_0: "Facts",_1: _U.list([$LL.NT("Fact"),$LL.NT("Facts")])}
           ,{ctor: "_Tuple2",_0: "Facts",_1: _U.list([$LL.NT("Fact")])}
           ,{ctor: "_Tuple2",_0: "Fact",_1: _U.list([$LL.T("!"),$LL.T("STRING")])}
           ,{ctor: "_Tuple2",_0: "Question",_1: _U.list([$LL.T("?"),$LL.T("STRING")])}]));
   var cfg_8_9 = A4($LL.CFG,
   "Session",
   _U.list(["Facts","Fact","Question"]),
   _U.list(["(",")","!","?","STRING"]),
   _U.list([{ctor: "_Tuple2",_0: "Session",_1: _U.list([$LL.NT("Facts"),$LL.NT("Question")])}
           ...
           ,{ctor: "_Tuple2",_0: "Fact",_1: _U.list([$LL.T("!"),$LL.T("STRING")])}
           ,{ctor: "_Tuple2",_0: "Question",_1: _U.list([$LL.T("?"),$LL.T("STRING")])}]));
   var cfg_8_7 = A4($LL.CFG,
   "Session",
   _U.list(["Fact","Question"]),
   _U.list(["!","?","(",")","STRING"]),
   _U.list([{ctor: "_Tuple2",_0: "Session",_1: _U.list([$LL.NT("Fact"),$LL.NT("Session")])}
           ,{ctor: "_Tuple2",_0: "Session",_1: _U.list([$LL.NT("Question")])}
           ,{ctor: "_Tuple2",_0: "Session",_1: _U.list([$LL.T("("),$LL.NT("Session"),$LL.T(")"),$LL.NT("Session")])}
           ,{ctor: "_Tuple2",_0: "Fact",_1: _U.list([$LL.T("!"),$LL.T("STRING")])}
           ,{ctor: "_Tuple2",_0: "Question",_1: _U.list([$LL.T("?"),$LL.T("STRING")])}]));
   var cfg_exercise = A4($LL.CFG,
   "S",
   _U.list(["A","B","C","D"]),
   _U.list(["a","b","c"]),
   _U.list([{ctor: "_Tuple2",_0: "S",_1: _U.list([$LL.NT("A"),$LL.NT("B")])}
           ,{ctor: "_Tuple2",_0: "A",_1: _U.list([$LL.NT("C"),$LL.T("a")])}
           ,{ctor: "_Tuple2",_0: "A",_1: _U.list([])}
           ,{ctor: "_Tuple2",_0: "B",_1: _U.list([$LL.T("c"),$LL.NT("D")])}
           ,{ctor: "_Tuple2",_0: "C",_1: _U.list([$LL.T("b")])}
           ,{ctor: "_Tuple2",_0: "C",_1: _U.list([])}
           ,{ctor: "_Tuple2",_0: "D",_1: _U.list([$LL.T("a"),$LL.NT("A"),$LL.NT("C"),$LL.NT("D")])}
           ,{ctor: "_Tuple2",_0: "D",_1: _U.list([])}]));
   var cfg_8_4 = A4($LL.CFG,
   "S",
   _U.list(["B"]),
   _U.list(["a","b"]),
   _U.list([{ctor: "_Tuple2",_0: "S",_1: _U.list([$LL.T("a"),$LL.NT("B")])}
           ,{ctor: "_Tuple2",_0: "B",_1: _U.list([$LL.T("b")])}
           ,{ctor: "_Tuple2",_0: "B",_1: _U.list([$LL.T("a"),$LL.NT("B"),$LL.T("b")])}]));
   var cfg_8_1 = A4($LL.CFG,
   "S",
   _U.list(["A","B"]),
   _U.list(["a","b"]),
   _U.list([{ctor: "_Tuple2",_0: "S",_1: _U.list([$LL.T("a"),$LL.NT("B")])}
           ,{ctor: "_Tuple2",_0: "S",_1: _U.list([$LL.T("b"),$LL.NT("A")])}
           ,{ctor: "_Tuple2",_0: "A",_1: _U.list([$LL.T("a")])}
           ,{ctor: "_Tuple2",_0: "A",_1: _U.list([$LL.T("a"),$LL.NT("S")])}
           ,{ctor: "_Tuple2",_0: "A",_1: _U.list([$LL.T("b"),$LL.NT("A"),$LL.NT("A")])}
           ,{ctor: "_Tuple2",_0: "B",_1: _U.list([$LL.T("b")])}
           ,{ctor: "_Tuple2",_0: "B",_1: _U.list([$LL.T("b"),$LL.NT("S")])}
           ,{ctor: "_Tuple2",_0: "B",_1: _U.list([$LL.T("a"),$LL.NT("B"),$LL.NT("B")])}]));
   return _elm.Examples.values = {_op: _op
                                 ,cfg_8_1: cfg_8_1
                                 ,cfg_8_4: cfg_8_4
                                 ,cfg_exercise: cfg_exercise
                                 ,cfg_8_7: cfg_8_7
                                 ,cfg_8_9: cfg_8_9
                                 ,cfg_8_9_no_eps: cfg_8_9_no_eps
                                 ,cfg_8_9_no_eps_mod: cfg_8_9_no_eps_mod
                                 ,cfg_exam: cfg_exam
                                 ,cfg_left_associative_arith: cfg_left_associative_arith
                                 ,cfg_left_associative_arith_norec: cfg_left_associative_arith_norec
                                 ,cfg_arith: cfg_arith
                                 ,cfg_arith_mod: cfg_arith_mod
                                 ,cfg_arith_simpl: cfg_arith_simpl
                                 ,cfg_arith_simpl_mod: cfg_arith_simpl_mod
                                 ,cfg_arith_simpl_mod_norec: cfg_arith_simpl_mod_norec
                                 ,cfg_lr_lecture: cfg_lr_lecture
                                 ,cfg_lr_exercise: cfg_lr_exercise};
};
Elm.Main = Elm.Main || {};
Elm.Main.make = function (_elm) {
   ...
   $Task = Elm.Task.make(_elm);
   var _op = {};
   var focusStepMailbox = $Signal.mailbox({ctor: "_Tuple0"});
   var focusStep = Elm.Native.Port.make(_elm).outboundSignal("focusStep",function (v) {    return [];},focusStepMailbox.signal);
   var switchedMailbox = $Signal.mailbox({ctor: "_Tuple0"});
   var switched = Elm.Native.Port.make(_elm).outboundSignal("switched",function (v) {    return [];},switchedMailbox.signal);
   var NoOp = {ctor: "NoOp"};
   var Switch = function (a) {    return {ctor: "Switch",_0: a};};
   var Escape = {ctor: "Escape"};
   var Arrows = function (a) {    return {ctor: "Arrows",_0: a};};
   var Forth = {ctor: "Forth"};
   var Back = {ctor: "Back"};
   var Component = function (a) {    return {ctor: "Component",_0: a};};
   var choices = _U.list([{ctor: "_Tuple2",_0: "zur Übungsaufgabe",_1: $Examples.cfg_exercise}
                         ,{ctor: "_Tuple2",_0: "aus Textbuch",_1: $Examples.cfg_8_7}
                         ,{ctor: "_Tuple2",_0: "aus Textbuch, Variante",_1: $Examples.cfg_8_9}
                         ,{ctor: "_Tuple2",_0: "Arithmetik",_1: $Examples.cfg_left_associative_arith}
                         ,{ctor: "_Tuple2",_0: "Arithmetik, Linksrekursion entfernt",_1: $Examples.cfg_left_associative_arith_norec}
                         ,{ctor: "_Tuple2",_0: "Session-Beispiel",_1: $Examples.cfg_8_9_no_eps}
                         ,{ctor: "_Tuple2",_0: "Session-Beispiel, linksfaktorisiert",_1: $Examples.cfg_8_9_no_eps_mod}
                         ,{ctor: "_Tuple2",_0: "Einführungsbeispiel",_1: $Examples.cfg_arith}
                         ,{ctor: "_Tuple2",_0: "Einführungsbeispiel, linksfaktorisiert",_1: $Examples.cfg_arith_mod}
                         ,{ctor: "_Tuple2",_0: "vereinfachtes Beispiel",_1: $Examples.cfg_arith_simpl}
                         ,{ctor: "_Tuple2",_0: "vereinfachtes Beispiel, linksfaktorisiert",_1: $Examples.cfg_arith_simpl_mod}
                         ,{ctor: "_Tuple2",_0: "vereinfachtes Beispiel, linksfaktorisiert, keine Linksrekursion",_1: $Examples.cfg_arith_simpl_mod_norec}
                         ,{ctor: "_Tuple2",_0: "fast triviales Beispiel",_1: $Examples.cfg_8_4}
                         ,{ctor: "_Tuple2",_0: "zur Klausuraufgabe",_1: $Examples.cfg_exam}
                         ,{ctor: "_Tuple2",_0: "LR-Beispiel aus Vorlesung",_1: $Examples.cfg_lr_lecture}
                         ,{ctor: "_Tuple2",_0: "LR-Beispiel aus Übung",_1: $Examples.cfg_lr_exercise}]);
   var view = F2(function (address,_p0) {
      var _p1 = _p0;
      return A2($Html.div,
      _U.list([]),
      A2($Basics._op["++"],
      _U.list([A2($Html.h3,_U.list([A2($Html$Attributes.property,"innerHTML",$Json$Encode.string("LL(1)-Analyse"))]),_U.list([]))
              ,A2($Html.select,
              _U.list([$Html$Attributes.id("choices")
                      ,A3($Html$Events.on,
                      "change",
                      A2($Json$Decode.at,_U.list(["target","selectedIndex"]),$Json$Decode.$int),
                      function (_p2) {
                         return A2($Signal.message,address,Switch(_p2));
                      })]),
              A2($List.map,function (_p3) {    var _p4 = _p3;return A2($Html.option,_U.list([]),_U.list([$Html.text(_p4._0)]));},choices))
              ,A2($Html.p,_U.list([]),_U.list([]))
              ,A2($Component.view,A2($Signal.forwardTo,address,Component),_p1.component)]),
      A2($Basics._op["++"],
      $List.isEmpty(_p1.previous) ? _U.list([]) : _U.list([A2($Html.button,_U.list([A2($Html$Events.onClick,address,Back)]),_U.list([$Html.text("Zurück")]))]),
      $List.isEmpty(_p1.next) ? _U.list([]) : _U.list([A2($Html.button,_U.list([A2($Html$Events.onClick,address,Forth)]),_U.list([$Html.text("Vor")]))]))));
   });
   var noEffects = A2($Basics.flip,F2(function (v0,v1) {    return {ctor: "_Tuple2",_0: v0,_1: v1};}),$Effects.none);
   var init = function () {
      var _p5 = $List.head(choices);
      if (_p5.ctor === "Nothing") {
            return _U.crashCase("Main",{start: {line: 41,column: 5},end: {line: 47,column: 77}},_p5)("IMPOSSIBLE!");
         } else {
            return noEffects({component: $Component.init(_p5._0._1),previous: _U.list([]),next: _U.list([])});
         }
   }();
   var update = F2(function (action,_p7) {
      update: while (true) {
         var _p8 = _p7;
         var _p17 = _p8.previous;
         var _p16 = _p8.next;
         var _p15 = _p8;
         var _p14 = _p8.component;
         var _p9 = {ctor: "_Tuple3",_0: _p17,_1: action,_2: _p16};
         _v4_7: do {
            if (_p9.ctor === "_Tuple3") {
                  switch (_p9._1.ctor)
                  {case "Component": var _p10 = _p9._1._0;
                       var component$ = A2($Component.update,_p10,_p14);
                       return {ctor: "_Tuple2"
                              ,_0: _U.eq(_p14,component$) ? _p15 : {previous: A2($List._op["::"],_p14,_p17),component: component$,next: _U.list([])}
                              ,_1: A2($List.member,_p10,_U.list([$Component.Follow,$Component.Predictions])) ? $Effects.task(A2($Task.map,
                              $Basics.always(NoOp),
                              A2($Signal.send,focusStepMailbox.address,{ctor: "_Tuple0"}))) : $Effects.none};
                     case "Back": if (_p9._0.ctor === "::") {
                             return noEffects({previous: _p9._0._1,component: _p9._0._0,next: A2($List._op["::"],_p14,_p16)});
                          } else {
                             break _v4_7;
                          }
                     case "Forth": if (_p9._2.ctor === "::") {
                             return noEffects({previous: A2($List._op["::"],_p14,_p17),component: _p9._2._0,next: _p9._2._1});
                          } else {
                             break _v4_7;
                          }
                     case "Arrows": var _p11 = _p9._1._0.y;
                       if (_U.eq(_p11,1)) {
                             var _v5 = Component($Component.Up),_v6 = _p15;
                             action = _v5;
                             _p7 = _v6;
                             continue update;
                          } else if (_U.eq(_p11,-1)) {
                                var _v7 = Component($Component.Down),_v8 = _p15;
                                action = _v7;
                                _p7 = _v8;
                                continue update;
                             } else return noEffects(_p15);
                     case "Escape": var _v9 = Component($Component.Escape),_v10 = _p15;
                       action = _v9;
                       _p7 = _v10;
                       continue update;
                     case "Switch": return {ctor: "_Tuple2"
                                           ,_0: function () {
                                              var _p12 = $List.head(A2($List.drop,_p9._1._0,choices));
                                              if (_p12.ctor === "Nothing") {
                                                    return _p15;
                                                 } else {
                                                    return {component: $Component.init(_p12._0._1),previous: _U.list([]),next: _U.list([])};
                                                 }
                                           }()
                                           ,_1: $Effects.task(A2($Task.map,$Basics.always(NoOp),A2($Signal.send,switchedMailbox.address,{ctor: "_Tuple0"})))};
                     default: return noEffects(_p15);}
               } else {
                  break _v4_7;
               }
         } while (false);
         return _U.crashCase("Main",{start: {line: 82,column: 5},end: {line: 131,column: 38}},_p9)("IMPOSSIBLE!");
      }
   });
   var app = $StartApp.start({init: init
                             ,view: view
                             ,update: update
                             ,inputs: _U.list([A2($Signal.map,Arrows,$Keyboard.arrows)
                                              ,A3($Signal.filterMap,
                                              function (b) {
                                                 return b ? $Maybe.Just(Escape) : $Maybe.Nothing;
                                              },
                                              NoOp,
                                              $Keyboard.isDown(27))])});
   var main = app.html;
   var run = Elm.Native.Task.make(_elm).performSignal("run",app.tasks);
